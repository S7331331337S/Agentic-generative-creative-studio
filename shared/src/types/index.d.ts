...
export type WsEventType = 'agent:status' | 'agent:output' | 'agent:error' | 'cluster:status' | 'cluster:scaled' | 'task:queued' | 'task:started' | 'task:completed' | 'task:failed' | 'workflow:started' | 'workflow:step-completed' | 'workflow:completed' | 'workflow:failed' | 'system:metrics' | 'knowledge:indexed';
